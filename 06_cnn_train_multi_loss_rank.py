...
# Training parameters
parser.add_argument("--model_type", type=str, default='vgg16', help="pre-trained model: vgg16 | resnet50 | vit_base")
...
parser.add_argument("--s_stop", type=int, default=5, help="the step of stop training")
parser.add_argument("--lr_step", type=int, default=200, help="the step of learning rate")
...
parser.add_argument("--celoss_type", type=str, default='celoss_node',
                    help="cross entropy losses: celoss_node | celoss_clip")
    ...
    if opt.do_train:
        ...
        for epoch in range(opt.n_epochs):
            ...
            for iter, (x_, y_) in enumerate(data_loader):
                ...
                optimizer.zero_grad()
                y_pred = model(x_)
                if opt.celoss_type == "celoss_clip" or opt.celoss_type == "celoss_node":
